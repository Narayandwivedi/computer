...
const Webcam = () => {
  ...
  const fetchWebcams = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/products/category/gaming-accessories/subcategory/webcam?${queryParams}`)
      ...
      setError('Failed to fetch webcam products')
      console.error('Error fetching webcam products:', err)
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="min-h-screen bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-3 text-gray-600">Loading Webcams...</span>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
            HD <span className="text-cyan-600">Webcams</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            HD webcams for streaming and video calls. 4K recording, auto focus,
            wide angle, and privacy shutter for professional streaming and video conferencing.
          </p>
        </div>
        ...
        {products.length > 0 ? (
            ...
            {products.map((product) => (
              <div key={product._id} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-4">
                  ...
                  <button 
                    onClick={() => navigate(`/computer-accessories/webcam/product/${product._id}`)}
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Webcams Found</h3>
