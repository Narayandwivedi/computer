      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            is here to help you build your perfect computing setup.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 text-white">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-cyan-300">support@jainxcomputers.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-cyan-300">123 Tech Street, Computer Market<br />New Delhi, India 110001</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-cyan-300">Mon - Sat: 10:00 AM - 8:00 PM<br />Sunday: 11:00 AM - 6:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-cyan-500 p-2 rounded-full hover:bg-cyan-600 transition-colors">
          ...
          <div className="bg-white">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p>📧 Email inquiries: Within 2-4 hours</p>
                <p>📞 Phone support: Immediate assistance</p>
                <p>🔧 Technical support: Same day resolution</p>
                <p>🚚 Order status: Real-time updates</p>
              </div>
            </div>
          </div>
        </div>
