...
const Processor = () => {
  ...
  const fetchProcessors = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/products/category/pc-parts/subcategory/processors?${queryParams}`)
      ...
      <div className="min-h-screen bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-64">
            ...
            <span className="ml-3 text-gray-600">Loading Processors...</span>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
            <span className="text-cyan-600">Processors</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            High-performance CPUs for gaming, content creation, and professional workloads.
            Find the perfect processor for your build from Intel and AMD.
          </p>
        </div>
        ...
        {products.length > 0 ? (
            ...
            {products.map((product) => (
              <div key={product._id} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-4">
                  ...
                  <button 
                    onClick={() => navigate(`/pc-parts/processors/product/${product._id}`)}
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Processors Found</h3>
